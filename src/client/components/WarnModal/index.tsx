...
export const WarnModal = (props: IComponentProps) => {
  ...
  return (
    <Modal
      ...
      footer={null}
      className={`modal__warn ${
        props.isERCXRC ? "modal__warn--ercxrc" : "modal__warn--xrcerc"
      }`}
    >
      ...
      <div>
        <Button
          onClick={props.close}
          className={`modal__warn__confirm w-full c-white`}
          type="primary"
        >
          {lang.t("ok")}
        </Button>
