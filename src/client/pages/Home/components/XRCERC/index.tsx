...
export const XRCERC = () => {
  ...
  const token = useMemo(() => (tokenInfoPair ? tokenInfoPair.ETHEREUM || tokenInfoPair.BSC || tokenInfoPair.POLYGON : null), [tokenInfoPair]);
    ...
    <div className="page__home__component__xrc_erc p-8 pt-6">
      <Form>
        <div className="my-6">
          <TokenSelectField
            network={IOTEX}
            toNetwork={base.chainToken.network.toUpperCase()}
            onChange={(tokenPair) => {
